...
class IndeedApply extends DataObject implements PermissionProvider
{
    ...
    private static $db = [
        ...
        'CandidateFullName'  => DBVarchar::class . '(255)',
        'CandidateFirstName' => DBVarchar::class . '(255)',
        'CandidateLastName'  => DBVarchar::class . '(255)',
    ...
    public function fieldLabels($includerelations = true)
    {
        ...
        $labels['CandidateFullName'] = _t(__CLASS__ . '.CandidateFullName', 'Full Name');
        $labels['CandidateFirstName'] = _t(__CLASS__ . '.CandidateFirstName', 'First Name');
        $labels['CandidateLastName'] = _t(__CLASS__ . '.CandidateLastName', 'Last Name');
    ...
    public function getCMSFields()
    {
        ...
        $fields->addFieldsToTab(
            'Root.Candidate',
            [
                $fields->dataFieldByName('CandidateFullName'),
                $fields->dataFieldByName('CandidateFirstName'),
                $fields->dataFieldByName('CandidateLastName'),
